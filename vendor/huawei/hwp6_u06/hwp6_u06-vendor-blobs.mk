...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/lib/hw/camera.k3v2oem1.so:system/lib/hw/camera.vendor.k3v2oem1.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/lib/libfrsdk.so:system/lib/libfrsdk.so \
    ...
    $(PATH_FILES)/lib/libndk1.so:system/lib/libndk1.so \
    $(PATH_FILES)/lib/libnetjni.so:system/lib/libnetjni.so \
